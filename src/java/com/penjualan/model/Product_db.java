...
public class Product_db implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Product_db)) {
            return false;
        }
        Product_db other = (Product_db) object;
    ...
    public String toString() {
        return "com.penjualan.model.Product[ id=" + id + " ]";
    }
